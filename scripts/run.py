#!/usr/bin/env python
"""Main entry point — trace deobfuscation pipeline.

Usage:
    uv run trace-deobf data/trace.jsonl
    uv run trace-deobf data/trace.jsonl --no-graph
"""
...
from trace_deobfuscation.bb_extractor import extract_and_split
from trace_deobfuscation.cfg_builder import build_cfg
from trace_deobfuscation.merger import iterative_merge
from trace_deobfuscation.models import BasicBlock, JumpType
from trace_deobfuscation.parser import parse_trace
...
def main() -> int:
    ...
    if not args.no_graph:
        ...
        try:
            from trace_deobfuscation.visualizer import draw_cfg_before_after
